...
class MariaDBIntegrationTestLatest:
    def __init__(self):
        """Initialize MariaDB Latest integration test"""
        ...
        self.container = None
        self.container_name = f"planb_test_mariadb_latest_{int(time.time())}"
    ...
    def start_database_container(self):
        """Start MariaDB Latest container for testing"""
        logger.info("🐬 Starting MariaDB Latest container...")
    ...
    def build_container(self):
        ...
        logger.info("🔨 Building MariaDB Latest backup container...")
        
        try:
            # Build the container
            image, build_logs = self.client.images.build(
                path="/Users/diablo/Projects/react/backup-runner/mariadb/latest",
                dockerfile="Dockerfile",
                tag="gcr.io/apito-cms/plan-b-backup-mariadb:test-latest",
                rm=True
            )
            
            logger.info("✅ MariaDB Latest backup container built successfully")
            return True
    ...
    def run_backup_test(self):
        ...
        logger.info("🧪 Running MariaDB Latest backup test...")
        
        try:
            # Run the backup container
            backup_container = self.client.containers.run(
                "gcr.io/apito-cms/plan-b-backup-mariadb:test-latest",
            ...
            if result['StatusCode'] == 0:
                logger.info("✅ MariaDB Latest backup test completed successfully")
    ...
    def push_to_gcr(self):
        ...
        logger.info("🚀 Pushing MariaDB Latest container to GCR...")
        ...
        try:
            ...
            image, build_logs = self.client.images.build(
                path="/Users/diablo/Projects/react/backup-runner/mariadb/latest",
                dockerfile="Dockerfile",
                tag="gcr.io/apito-cms/plan-b-backup-mariadb:latest",
            ...
            for line in self.client.images.push(
                "gcr.io/apito-cms/plan-b-backup-mariadb:latest",
                stream=True,
                decode=True
            ):
                if 'status' in line:
            ...
            logger.info("✅ MariaDB Latest container pushed to GCR successfully")
            return True
    ...
    def run_full_test(self):
        """Run the complete MariaDB Latest integration test"""
        logger.info("🚀 Starting MariaDB Latest Build & Test Pipeline")
        logger.info("=" * 60)
        ...
        try:
            ...
            logger.info("🎉 MariaDB Latest integration test completed successfully!")
            return True
            
        except Exception as e:
            logger.error(f"❌ MariaDB Latest integration test failed: {e}")
            return False
        finally:
            self.cleanup()

if __name__ == '__main__':
    test = MariaDBIntegrationTestLatest()
