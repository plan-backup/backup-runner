#!/usr/bin/env python3
"""
Plan B Integration Test - Cassandra 4.1
...
class CassandraIntegrationTest:
    ...
    def start_database_container(self):
        """Start Cassandra 4.1 container for testing"""
        logger.info("📊 Starting Cassandra 4.1 container...")
    ...
    def run_backup_test(self):
        ...
        try:
            ...
            build_result = subprocess.run([
                ...
                '-f', '././cassandra/4.1/Dockerfile',
                '-t', f'planb-backup-cassandra-4.1-test',
                '.'
    ...
    def cleanup(self):
        ...
        try:
            self.client.images.remove(f'planb-backup-cassandra-4.1-test', force=True)
        except:
            pass
    
    def run_full_test(self):
        """Run complete backup/restore integration test"""
        logger.info("🚀 Starting Cassandra 4.1 Integration Test")
        logger.info("=" * 50)
        ...
        try:
            ...
            logger.info("🎉 Cassandra 4.1 Integration Test PASSED!")
            return True
