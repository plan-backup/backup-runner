...
class PostgreSQLRunner(BackupBase):
    """PostgreSQL 16 backup and restore runner"""
    ...
    def __init__(self):
        ...
        self.ssl_enabled = os.getenv('SSL_MODE', 'false').lower() == 'true'
        self.ssl_mode = 'require' if self.ssl_enabled else 'prefer'  # Map boolean to PostgreSQL sslmode
        ...
        logger.info(f"🔍 SSL enabled: {self.ssl_enabled} (mode: {self.ssl_mode})")
