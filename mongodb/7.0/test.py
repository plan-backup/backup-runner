...
class MongoDBIntegrationTest70:
    def __init__(self):
    ...
    def start_database_container(self):
        ...
        try:
            ...
            self.container_name = f"planb_test_mongodb_70_{int(time.time())}"
    ...
    def build_container(self):
        ...
        try:
            ...
            build_result = subprocess.run([
                'docker', 'build', 
                '-f', './mongodb/7.0/Dockerfile',
                '-t', 'gcr.io/apito-cms/plan-b-backup-mongodb:test-70',
                '.'
        ...
        try:
            ...
            try:
                backup_output = self.client.containers.run(
                    'gcr.io/apito-cms/plan-b-backup-mongodb:test-70',
    ...
    def push_to_gcr(self):
        ...
        try:
            ...
            build_result = subprocess.run([
                ...
                '-f', './mongodb/7.0/Dockerfile',
                '-t', 'gcr.io/apito-cms/plan-b-backup-mongodb:7.0',
                '.'
            ], capture_output=True, text=True, cwd='/Users/diablo/Projects/react/backup-runner')
            ...
            push_result = subprocess.run([
                'docker', 'push', 'gcr.io/apito-cms/plan-b-backup-mongodb:7.0'
            ], capture_output=True, text=True)
            
            if push_result.returncode == 0:
                logger.info("✅ Successfully pushed to Google Container Registry!")
                logger.info("🏷️  Image: gcr.io/apito-cms/plan-b-backup-mongodb:7.0")
                return True
            else:
    ...
    def run_full_test(self):
        ...
        logger.info("🚀 Starting MongoDB 7.0 Build & Test Pipeline")
        logger.info("=" * 60)
        ...
        try:
            ...
            logger.info("🎉 MongoDB 7.0 Pipeline COMPLETED SUCCESSFULLY!")
